...
func shoot(unit_obj_shooter: UnitObject, unit_obj_enemy: UnitObject, is_hitted: bool):
	...
	var point_from: Vector3 = unit_obj_shooter.unit_visual.muzzle_flesh.global_transform.origin
	var point_to: Vector3 = unit_obj_enemy.hit_bullet_point.global_transform.origin
	...
	new_instance.global_transform.origin = point_from
